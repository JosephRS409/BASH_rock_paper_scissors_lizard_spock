...
# computer function THIS GOES SECOND
...
# compare function THIS GOES THIRD
...
# human input function for input, I think?
# THIS GOES FIRST
...
# (( $input != 6 ]]
	...
	then
		...
		computer_function 
		compare_function
# [[]]'s are for characters and strings
# (())'s are for numeric values	
	else
		echo "
Invalid answer.
